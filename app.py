...
def show_all_docs_info():
    ...
    all_documents = list()
    for current_document in documents:
       all_documents.append(show_document_info(current_document))
    return all_documents


def add_new_doc(new_doc_number=None, new_doc_type=None, new_doc_owner_name=None, new_doc_shelf_number=None):
    if not new_doc_number or not new_doc_type or not new_doc_owner_name or not new_doc_shelf_number:
